...
@Data
@Builder  //patron para instanciar
@NoArgsConstructor  // te crea contructores no tiene argumentos
@AllArgsConstructor  // te crea contrustores con todos los parametros
public class Producto {

    private Long idProducto;
    @NotBlank(message = "El nombre del producto es obligatorio")  //@ siver para validar el nombre para que sea obligatorio
    private String nombre;

    private TipoProducto tipoProducto;
    @NotNull(message = "El precio del producto es obligatorio")
    @Positive(message = "El precio del producto debe ser positivo")  // que siempre sea positivo
    private Double pu;
